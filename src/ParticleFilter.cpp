...
Action ParticleFilter::sensorUpdate(Observation *obs, Action *act, Episodes *ep, turtlebot_gamepad_training_replay::PFoEOutput *out)
{
	out->eta = 0.0;
...
{
	double diff[6] = {	past->log_ls - last->log_ls,
                past->log_lm - last->log_lm,
